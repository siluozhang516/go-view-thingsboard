...
export const defaultIcons: any[] = [
          ...
          form: [
            {
              ...
              placeholder: '仅绑定变量',
              multiple: true,
              isTime: false, // isTime 是否实时，用于折线图与柱状图，若实时多条线
              isYCategory: false, // 是否 Y 轴为 category，用于折线图与柱状图
              dataIds: [{ dataId: 'd-2-a-003', name: '空调' }]
            },
            {
              key: 'echarts',
              name: 'echarts',
  ...
  //         width: 100,
  //         height: 100,
  //         video: 'https://videos.pexels.com/video-files/3135811/3135811-hd_1920_1080_24fps.mp4',
  //         autoPlay: true,
  //         externElement: true
  //       }
  //     },
