...
export enum PageEnum {
  ...
  // meta2d
  META2DEDIT = '/project/meta2d/Edit',
  BASE_HOME_EDIT = 'Project-META-EDIT',
  META2DPREVIEW = '/project/meta2d/preview',
  BASE_HOME_PREVIEW = 'Project-META-PREVIEW',

  // thingsboard
  THINGSBOARDEDIT = '/project/thingsboard/Edit',
  BASE_HOME_THINGSBOARD = 'Thingsboard-Edit',
