...
const importPath = {
  ...
  'PageEnum.BASE_HOME_EDIT': () => import('@/views/project/meta2d/Edit.vue'),
  'PageEnum.BASE_HOME_THINGSBOARD': () => import('@/views/project/thingsboard/Edit.vue'),
}
...
const projectRoutes: RouteRecordRaw = {
  ...
  children: [
    ...
    {
      path: PageEnum.META2DEDIT,
      name: PageEnum.BASE_HOME_EDIT,
      component:  importPath['PageEnum.BASE_HOME_EDIT'],
      meta: {
        title: '组态图编辑'
      }
    },
    {
      path: PageEnum.THINGSBOARDEDIT,
      name: PageEnum.BASE_HOME_THINGSBOARD,
      component: importPath['PageEnum.BASE_HOME_THINGSBOARD'],
      meta: {
        title: 'Thingsboard部件编辑'
      }
    },
  ]
}
