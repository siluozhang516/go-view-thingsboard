...
import tinigsboard, { FormValue } from '@thingsboard/core'
import { EntityDataKeys } from '@thingsboard/widget'
...
export interface RequestConfigType extends RequestPublicConfigType {
  ...
  subscribe: {
    ...
    keyFilter?: tinigsboard.KeyFilter[] | null
    timeWindowConfig?: tinigsboard.Timewindow | null
    realtime: boolean
    datakeys: EntityDataKeys
    pageLink: thingsboard.EntityDataPageLink
  }
}
